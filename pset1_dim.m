...
%% Initial r and v
r = [.98900883730044109; 0; 0.000802140914099732]*dis.sun;
v = [0; 0.010697471710460349-2.896403e-3; 0]*dis.sun*omega; % be careful changing. Very sensitive.
...
tstart = 0;
tint = 25;
tend = 3600*24*177.15; % convert to nondimensional time
% tend = 3600*24*365*omega; % convert to nondimensional time

options = odeset('RelTol', 1e-3, 'AbsTol', 1e-6); 
[t_out, y_out] = ode113(@orbit_prop_dim, [tstart:tint:tend]', state_sc_earth, options); 
